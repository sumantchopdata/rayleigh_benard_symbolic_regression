...
snapshots.add_task(d3.lap(h), name='lap_of_height')
snapshots.add_task(d3.lap(d3.lap(h)), name='lap_of_lap_of_height')
snapshots.add_task(d3.lap(d3.lap(u)), name='lap_of_lap_of_velocity')
snapshots.add_task(d3.div(u), name='div_of_velocity')
snapshots.add_task(d3.div(h*u), name='div_of_h_times_u')
snapshots.add_task(d3.grad(h), name='grad_of_height')
snapshots.add_task(d3.grad(u), name='grad_of_velocity')
snapshots.add_task(zcross(u), name='zcross_of_velocity')
